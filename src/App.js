...
class App extends Component {
  ...
  onDeleteIcon = id => {
    ...
    const filterList = trackList.filter(eachItem => eachItem.id !== id)
    this.setState({trackList: filterList})
  }
  ...
  render() {
    ...
    const searchDetailsList = trackList.filter(eachSearch =>
      ...
      <>
        ...
        <div className="banner-container">
          <div className="heading-input-container">
            <h1 className="banner-heading">Songs Playlist</h1>
